...
void set_up() {
    ...
    mvaddstr(BOT_ROW + 3, 3, "press 'a' or 'd' to move pad, 'q' or 'Q' to quit game.");

    border(DEFAULT_CHAR, DEFAULT_CHAR, DEFAULT_CHAR, BLANK, DEFAULT_CHAR, DEFAULT_CHAR, BLANK, BLANK);
